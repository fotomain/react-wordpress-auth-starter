...
class App extends React.Component {
    constructor(props) {
        ...
        var state1 = {
            ...
            box_poin_selected_x:0,
            box_poin_selected_y:0,
            mouse_x:0,
            mouse_y:0,
            mouse_down: false,
            // touch_down: false,
...
componentDidUpdate(prevProps, prevState, snapshot, timer) {
    ...
    render_paint() {
        ...
        if(this.state?.mouse_down) {
            ...
            this.setState (() => ({
                box_poin_selected_x: x_center,
                box_poin_selected_y: y_center,
                ['red']:    p[0],
                ['green']:  p[1],
                ['blue']:   p[2],
                ['alpha']:  p[3],
        ...
        if((this.state?.box_poin_selected_x && this.state?.box_poin_selected_y)) {

             x_center = this.state.box_poin_selected_x
             y_center = this.state.box_poin_selected_y
        ...
        return (
            <>
                ...
                <div style={{color:'red', position:'relative', marginTop:'5px'}}>
                    ...
                    {this.state?.box_poin_selected_x}
                    <br>
                    </br>
                    {this.state?.box_poin_selected_y}
                </div>
