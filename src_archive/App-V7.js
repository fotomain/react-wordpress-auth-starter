...
class App extends React.Component {
    constructor(props) {
        ...
        const tStartColor_rgb = tinycolor(tStartColor).toRgb()
        const tStartColor_hex = tinycolor(tStartColor).toHex()
        ...
        this.state = {
            ...
            y1:0,
            y2:0,
            color_main:     tStartColor,
            color_new:      tStartColor,
            color_current:  tStartColor,
    ...
    onChange_rgb = ({e, p_name}) => {
        ...
        if("hex" == p_name){
            ...
            var hex =  tinycolor(e.target.value).toHex()
            this.setState (() => ({
