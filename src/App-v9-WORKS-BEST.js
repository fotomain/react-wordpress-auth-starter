    ...
    render() {
        return (
            <>
                ...
                <div className="all-canvas-row">>
                    <div className="spectrum-map">

                        <canvas id="color-block"
                                className="spectrum_canvas "
                                height  ="220px"
                                width   ="220px"
                    ...
                    <div className="ok-row">
                        ...
                        {(this.state.device_is_mobile)?'':

                        <fieldset className="ok-row-item ok-legend">
                            <legend>covered</legend>
                            {/*<div style={{marginLeft:"1rem"}}>*/}
                            {/*    <h4 >Covered</h4>*/}
                            {/*</div>*/}
                            <label htmlFor="color_сovered" id="color-label"
                                   style={{backgroundColor: this.state.color_сovered}}></label>
                        ...
                        <fieldset className="ok-row-item ok-legend">
                            ...
                            {/*    <h4 >Covered</h4>*/}
                            {/*</div>*/}
                            <label htmlFor="color_input" id="color-label"
                                   style={{backgroundColor: this.state.color_current}}></label>
                            <input hidden type="checkbox" id="color-input" checked onChange={this.onChange_ColorInput}></input>
                        </fieldset>

                        {/*<fieldset className="ok-row-item">*/}
                        {/*    <legend>Selected</legend>*/}
                        {/*    <label htmlFor="color-input" id="color-label"*/}
                        {/*           style={{marginLeft:"1rem", backgroundColor: this.state.hex}}></label>*/}
                        {/*    <input type="checkbox" id="color-input" checked onChange={this.onChange_ColorInput}></input>*/}
                        {/*</fieldset>*/}


                        <fieldset className="ok-row-item ok-legend-no-bordered " >
                            <legend>-</legend>
                            <button className="button_ok">Ok</button>
                        </fieldset>
                        ...
                        <div  className="panel-row">
                            ...
                            <fieldset id="rgb-fields" className="field-group value-fields rgb-fields active rgb-legend">
