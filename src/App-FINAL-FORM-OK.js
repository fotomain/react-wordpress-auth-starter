                        ...
                        (<form onSubmit={handleSubmit}>
                            ...
                            <Box sx={{
                                ...
                                >
                                    ...
                                    {/*sx={{visibility:*/}
                                    {/*    (this.showColor1m)?'visible':'hidden'*/}
                                    {/*{(!this.showColor1m) ? '' :*/}
                                    ...
                                    <Button
                                        ...
                                        onClick={ ()=>{
                                            ...
                                            setFieldValue('show1', !values.show1)

                                            this.setState = {
                                                showColor1: !this.state.showColor1,
                                                showColor1m: !this.state.showColor1m
                                            }
                                            this.showColor1m =  !this.showColor1m;
                                            console.log(this.state.showColor1)
                                            console.log(this.state.showColor1m)
